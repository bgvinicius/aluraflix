package br.tecprog.aluraflix.integration.categories;
...
public class CategoriesGetTest {
    ...
    public boolean findInList(Category category) {
        return rawCategories.stream().anyMatch(o -> o.getTitle().equals(category.getTitle()) && o.getColor().equals(category.getColor()));
    }
